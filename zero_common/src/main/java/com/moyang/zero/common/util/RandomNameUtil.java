...
public class RandomNameUtil {
	...
	public static String randomName() {
		...
		String[] firstNameArr = {"万俟","司马","上官","欧阳","夏侯","诸葛","闻人","东方",
				"赫连","皇甫","尉迟","公羊","澹台","公冶","宗政","濮阳","淳于","单于","太叔","申屠",
				"公孙","仲孙","轩辕","令狐","锺离","宇文","长孙","慕容","鲜于","闾丘","司徒","司空",
				"丌官","司寇","子车","颛孙","端木","巫马","公西","漆雕","乐正","壤驷","公良",
				"拓拔","夹谷","宰父","谷梁","段干","百里","东郭","南门","呼延","羊舌","微生",
				"梁丘","左丘","东门","西门","南宫"};

		String [] symbols = {"&", "@", "*", "$", "%", "#", "~", "de", "之", "的", "地"};
		...
		int surNameLen = firstNameArr.length;
		int wordLen = word.length;

		Random random = new Random();
		return firstNameArr[random.nextInt(surNameLen)] + symbols[random.nextInt(symbols.length)] +
				word[random.nextInt(wordLen)];
	}
}
