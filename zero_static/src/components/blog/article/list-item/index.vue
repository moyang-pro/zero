<template>
    <div class="article-item-card">
        <div class="article-show-item">
            ...
            <span class="text-two-line title-line-width text-des" :title="articleInfo.des" @click.stop="showArticle(articleInfo.id)">{{ articleInfo.des }}</span>
            <div class="article-item-opt">
                ...
                <span class="text-span-line">
                    <span class="text-span-item" title="发布时间"><i class="el-icon-time" style="margin-right: 5px"></i> {{ recently ? recentTimeDes : articleInfo.createAt }}</span>
                    <span class="text-span-item" title="浏览量"><i class="el-icon-view" style="margin-right: 5px"></i>{{ articleInfo.readCount }}</span>
                    <span class="text-span-item" title="浏览人数"><i class="el-icon-user" style="margin-right: 5px"></i>{{ articleInfo.userCount }}</span>
                    <span class="text-span-item" title="Star数量"><i class="el-icon-star-on" style="margin-right: 5px"></i>{{ articleInfo.collectCount }}</span>
                </span>
            </div>
        </div>
